                ...
                <div class="col-md-12 column">
                    <table class="table table-bordered table-hover">
                        ...
                        <#list booksList.records as book>
                            <tr>
                                ...
                                <#--<td><img height="100" width="100" src="${book.bookIcon}"></td>-->
                                <td>${book.bookDesc}</td>
                                <td><span class="label label-info">${book.bookStatusEnum().msg}</span></td>
                                <td>${book.createTime?string("yyyy-MM-dd HH:mm")}</td>
                                <td><a href="/admin/successcheck?bookId=${book.bookId}">通过</a></td>
                                <td><a href="/admin/uncheck?bookId=${book.bookId}">驳回</a>
                                </td>
                            </tr>
                        </#list>
                        </tbody>
                    ...
                    <div style="display: flex;flex-direction: row">
                        <ul class="pagination" style="margin-left: 20px">
                            <li>
                                <a href="/admin/checkbooks?page=1" aria-label="Previous">
                            ...
                            <#else>
                                <li>
                                    <a href="/admin/checkbooks?page=${currentPage-1}">
                            ...
                            <#if totalPage lte 5>
                                ...
                                <#list 1..totalPage as index>
                                    <#if currentPage==index>
                                        <li class="disabled">
                                            <a href="/admin/checkbooks?page=${index}">${index}</a>
                                        </li>
                                    <#else >
                                        <li>
                                            <a href="/admin/checkbooks?page=${index}">${index}</a>
                            ...
                            <li>
                                <a href="/admin/checkbooks?page=${totalPage}" aria-label="Next">
